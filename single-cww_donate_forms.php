<?php 
require_once('donate_form/donate-process.php');
			...
			<div class="content">
			 ...
			 <form id="donateform" class="donate" method="POST" enctype="multipart/form-data"><input type="hidden" />
			  ...
			  <div id="donor-wrap" class="donor-wrap">
			   ...
			   <?php if ($df_mc_list_id) : ?>
			   <div id="subscribe-wrap" class="input-wrap checkbox single">
			    <input id="df_subscribe" type="checkbox" name="df_subscribe" value="1" <?php echo (empty($df_clean) || $df_clean['df_subscribe'] ? 'checked="checked"' : ''); ?> style="padding-right: 16px;" />
